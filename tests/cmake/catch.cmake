...
ExternalProject_Add(
  ...
  URL "https://raw.githubusercontent.com/catchorg/Catch2/v2.13.2/single_include/catch.hpp"
  CONFIGURE_COMMAND ""
  BUILD_COMMAND ""
  INSTALL_COMMAND ""
  TEST_COMMAND ""
...
if(NOT EXISTS "${CATCH_MODULE_PATH}/Catch.cmake")
    file(DOWNLOAD "https://raw.githubusercontent.com/catchorg/Catch2/v2.13.2/contrib/Catch.cmake"
        "${CATCH_MODULE_PATH}/Catch.cmake")
endif()
if(NOT EXISTS "${CATCH_MODULE_PATH}/CatchAddTests.cmake")
    file(DOWNLOAD "https://raw.githubusercontent.com/catchorg/Catch2/v2.13.2/contrib/CatchAddTests.cmake"
